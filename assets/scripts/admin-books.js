...
const correct_publication_year= document.querySelector("#correct_publication_year")
    ...
    (snapshot)=>{
        ...
        let html_arr=All_books_obj.map((item,i)=>{
           ...
           let unic_id_correct=`correct${i}`
            ...
            <tr class="b_tr">
                        ...
                        <th class="th_book_title_b"><img src="${item.imageUrl}" alt=""> <p>${item.title}</p></th>
        ...
        function correct_el_in_fireBase(id,i){
          ...
          el.addEventListener("click",()=>{
            ...
            obj.bookType=undefined ?  coorecy_type_input.value=`Uncnown type`:coorecy_type_input.value=obj.bookType;
            correct_description.value=obj.description
            obj.isNew=true? correct_checkbox.checked=true : NaN;
            // filling forum

            //set information to fire base
            let key = all_keys[i]
            ...
            correct_btn.addEventListener("click",()=>{
              ...
              console.log(condition1,condition2,condition3,condition4,condition5,condition6,condition7);
